...
export const methodGroups: MethodGroup[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      { name: "Simulated annealing", functions: ["sa"], href: "/methods/simulated-annealing/", lab: true },
  ...
  },
  {
    ...
    methods: [
      ...
      { name: "Wave equation, 1D", functions: ["wave"], href: "/methods/wave-equation/", lab: true },
