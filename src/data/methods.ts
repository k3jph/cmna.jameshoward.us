...
export const methodGroups: MethodGroup[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      { name: "Polynomial interpolation", functions: ["polyinterp"] },
      { name: "Piecewise linear interpolation", functions: ["pwiselinterp"] },
      { name: "Cubic spline", functions: ["cubicspline"] },
  ...
  },
  {
    ...
    methods: [
      ...
      { name: "Gauss-Legendre quadrature", functions: ["gauss.legendre"] },
      { name: "Recursive adaptive integration", functions: ["adaptint"] },
      { name: "Romberg integration", functions: ["romberg"] },
      { name: "Monte Carlo integration, 1D", functions: ["mcint"] },
